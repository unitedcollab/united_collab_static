...
function() {
    ...
    function(r, a) {
        ...
        return d.namespace = "outlayer", d.Item = o, d.defaults = {
            ...
            this[t] = o ? ("string" == typeof o ? i = this.element.querySelector(o) : a.isElement(o) && (i = o), i ? n(i)[e] : o) : 0
    ...
    function(t) {
        ...
        r = "classList" in document.documentElement ? (o = function(t, e) {
...
function debounce(t, e) {
    ...
    ft.fn.The_Grid = function(t) {
        return this.each(function() {
                ...
                if ("justified" !== X.style) {
                    ...
                    for (var t = 0; t < M.length; t++) {
                        var e = M.eq(t).data("col"),
                            i = M.eq(t).data("row");
                        i = "horizontal" === X.layout && i > X.row ? X.row : i, d = 1 === h ? (u = p, f) : h < e ? (c = Math.round(h / (e / i)), u = h * p + (h - 1) * l, 1 === (c = c <= 1 ? 1 : c) ? f : c * f + (c - 1) * l) : (u = e * p + (e - 1) * l, i * f + (i - 1) * l), M.eq(t).width(u), "grid" === X.style ? M.eq(t).height(d) : null
                    }
                }
            }
            ...
            function dt() {
                var t;
                "horizontal" === X.layout && (t = "masonry" === X.style ? (C.removeClass("tg-grid-loading"), Math.max.apply(null, M.map(function() {
                    return ft(this).height()
                }).get())) : f * X.row + l * (X.row - 1), y.add(S).height(t))
            }

            function ct() {
                var t, e, i = !1;
                t = e = "horizontal" === X.layout ? (i = !0, "grid" === X.style ? "packery" : "justified" === X.style ? "justified" : "horizontal") : "grid" === X.style ? "packery" : X.style;
                var o = {};
        ...
        return this.each(function() {
            ...
            if (!t.hasClass(r) && "about:blank" !== e) {
                ...
                i.bind(SC.Widget.Events.READY, function() {
                    i.getCurrentSound, ft.TG_Media_Ready(t, i, "STD"), i.bind(SC.Widget.Events.PAUSE, function() {
                        ft.TG_Media_Pause(t)
