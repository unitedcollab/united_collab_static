    ...
    Object.defineProperty(e, "__esModule", {
        ...
        ["initImg", "canInitParallax", "init", "destroy", "clipContainer", "coverImage", "isVisible", "onScroll", "onResize"].forEach(function(f) {
            ...
            e.prototype[f] = function() {
                var t = this,
                    e = arguments || [];
                if ("initImg" === f && null !== t.$item.getAttribute("data-jarallax-element") && (t.options.type = "element", t.pureOptions.speed = t.$item.getAttribute("data-jarallax-element") || t.pureOptions.speed), "element" !== t.options.type) return y.apply(t, e);
                switch (t.pureOptions.threshold = t.$item.getAttribute("data-threshold") || "", f) {
                    case "init":
                        ...
                        t.options.thresholdY = o[0] ? parseFloat(o[0]) : null, t.options.thresholdX = o[1] ? parseFloat(o[1]) : null, y.apply(t, e);
                    ...
                    case "onScroll":
                        var l = t.getWindowData(),
                            ...
                            d = u,
                            p = c;
                        null !== t.options.thresholdY && u > t.options.thresholdY && (d = 0), null !== t.options.thresholdX && c > t.options.thresholdX && (p = 0), t.css(t.$item, {
                            transform: "translate3d(" + p + "px," + d + "px,0)"
                        });
                        break;
                    case "initImg":
                    case "isVisible":
